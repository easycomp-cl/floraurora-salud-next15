-- =============================================
-- Actualizar los porcentajes de comisión de los planes
-- Fecha: 2026-02-04
-- =============================================

-- Actualizar el valor de la comisión del Plan Light a 15% (comisión por sesión, no requiere pago mensual)
...
VALUES 
  ('plan_light_commission_percentage', '15', 'Porcentaje de comisión del Plan Light por sesión (no requiere pago mensual)', 'number', 'pricing', NULL)
...
-- Crear/actualizar la configuración de comisión por sesiones extra del Plan Premium (1.6%)
INSERT INTO system_configurations (config_key, config_value, description, data_type, category, created_by)
VALUES 
