    ...
    <>
      ...
      <section className="relative min-h-[350px] md:min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full flex justify-center md:justify-start">
          ...
          <div className="flex flex-col items-center md:items-start justify-center gap-4 max-w-xl w-full px-6 py-10 md:px-12 md:py-0 md:ml-0 md:mr-auto md:w-1/2">
            <Image
              src={logoImge}
            ...
            <p className="text-lg md:text-xl text-primary-700 mb-4 text-center md:text-left">
              Cuidamos el bienestar de las personas,
              <br />
              desde la raíz
            </p>
      ...
      <section className="bg-teal-100 py-12 px-4 md:px-16">
        <div className="max-w-5xl mx-auto">
          <h3 className="text-xl font-semibold text-teal-900 mb-2 uppercase tracking-wide">
            Nuestros servicios
          </h3>
          <p className="mb-8 text-lg text-teal-900">
            FlorAurora Salud ofrece atención de primera.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              <Image
                ...
                priority
              />
              <h4 className="font-bold text-lg text-teal-900 mb-1 text-center">
      ...
      <section className="bg-teal-200 py-12 px-4 md:px-16">
        <div className="max-w-5xl mx-auto">
          <h3 className="text-3xl font-bold text-teal-900 mb-8 text-center">
            Conoce a nuestros profesionales
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              ...
              <h4 className="font-bold text-lg text-teal-900 mb-1">
                Ps. Sandra Herrera
              </h4>
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              ...
              <p className="text-xs text-gray-600 mb-2">
                Como Psicólogo se especializa en psicología.
              </p>
            ...
            <div className="bg-white rounded-lg shadow p-6 flex flex-col items-center">
              ...
              <p className="text-xs text-gray-600 mb-2">
                La Ps. Soto cuenta con más de 15 años de experiencia en las
                áreas de psicología y salud mental.
              </p>
