...
export default function Servicios() {
  ...
  const smoothScrollTo = useCallback(
    (element: HTMLElement, duration: number = 800, offset: number = 0) => {
  ...
  const scrollToService = useCallback(
    (hash: string, fromExternalPage: boolean = false) => {
      if (!hash) return;
    ...
    const handleInitialScroll = () => {
      ...
      setTimeout(() => {
        ...
        if (hash) {
          ...
          const wasOnServicesPage =
            sessionStorage.getItem("wasOnServicesPage") === "true";
      ...
      if (link && link.href.includes("/services#")) {
        ...
        if (hash) {
          ...
          if (isOnServicesPage) {
            ...
            // Disparar evento personalizado para cerrar el dropdown del navbar
            const closeDropdownEvent = new CustomEvent("closeNavbarDropdown");
          ...
          <div className="grid gap-8 grid-cols-1">
            ...
            >
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
                  La psicoterapia Infanto juvenil es una intervención
                  psicológica orientada a diagnosticar y tratar problemas
                  emocionales, conductuales, sociales y del desarrollo tanto en
                  niños como en adolescentes, a través de herramientas adecuadas
                  a la edad del paciente, trabajando con la familia cada vez que
                  fuere necesario. Contamos con profesionales capacitados para
                  responder a las necesidades psicoterapéuticas tanto de niños
                  como adolescentes.
                </p>
            ...
            >
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
                  ...
                  conflictos emocionales, así como la comprensión y modificación
                  de pensamientos y conductas disfuncionales que pudieran
                  afectar en relaciones interpersonales, toma de decisiones y
                  confrontación de situaciones de la vida cotidiana.Te invitamos
                  a conocer a los profesionales que trabajan en FlorAurora.
                </p>
                <ul className="space-y-2 text-gray-600 text-sm md:text-base mb-6">
                  <li className="flex items-center gap-2">
                    <Check className="text-teal-500 w-5 h-5 flex-shrink-0" />{" "}
            ...
            >
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
                  ...
                  satisfactoria, respondiendo a las necesidades de ambos
                  miembros de la pareja. El psicólogo a cargo cumple con un rol
                  neutral que favorece la construcción de dichas habilidades.
                </p>
                <ul className="space-y-2 text-gray-600 text-sm md:text-base mb-6">
                  <li className="flex items-center gap-2">
                    <Check className="text-teal-500 w-5 h-5 flex-shrink-0" />{" "}
            ...
            >
              <div className="flex-1 flex flex-col">
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-6">
                  Es el proceso llevado a cabo por un psicólogo especializado
                  para comprender la estructura de personalidad, funcionamiento
                  cognitivo y posibles trastornos en un individuo, a través de
                  un proceso metódico y estructurado y la aplicación de baterías
                  y test para cada necesidad específica.
                </p>
                <ul className="space-y-2 text-gray-600 text-sm md:text-base mb-6">
                  <li className="flex items-center gap-2">
                    <Check className="text-teal-500 w-5 h-5 flex-shrink-0" />{" "}
