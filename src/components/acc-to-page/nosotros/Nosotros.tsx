    ...
    <section className="w-full">
      ...
      <div className="relative h-[340px] md:h-[420px]">
        ...
        <div className="relative z-10 h-full max-w-5xl mx-auto px-6 flex flex-col items-center justify-center text-center">
          ...
          />
          {/* Título centrado */}
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 w-full text-center">Nosotros</h1>
          <p className="mt-4 max-w-3xl text-base md:text-lg text-gray-700">
            FlorAurora Salud es el servicio online de atención psicológica y médica más
            confiable del país. Contamos con un equipo de expertos altamente capacitados,
            plataformas modernas y un compromiso inquebrantable con el bienestar de nuestros pacientes.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-16">
          ...
          <div className="mt-6 md:mt-8 bg-white rounded-2xl shadow-md px-6 py-8 md:px-10 md:py-10 text-center">
            ...
            <p className="mt-4 md:mt-6 text-gray-600 max-w-3xl mx-auto">
              Entregar un servicio online que permita conectar a profesionales de la salud con consultantes, 
              a través de una plataforma tecnológica moderna y eficiente, 
              garantizando calidad, seguridad y confianza en el vínculo.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-teal-300/80">
        <div className="max-w-5xl mx-auto px-6 py-12 md:py-16">
          ...
          <div className="mt-6 md:mt-8 bg-white rounded-2xl shadow-md px-6 py-8 md:px-10 md:py-10 text-center">
            ...
            <p className="mt-4 md:mt-6 text-gray-600 max-w-3xl mx-auto">
              Consolidarnos como una empresa líder en servicios de calidad, que inspire confianza, además  de innovar tecnológicamente,
               con el compromiso de la salud y  el bienestar de nuestros clientes.
            </p>
          </div>
        </div>
      </section>
